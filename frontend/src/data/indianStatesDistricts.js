// Complete list of Indian States, Union Territories, and their Districts
// Data sourced from https://igod.gov.in/sg/district/states
...
export const indianStatesAndDistricts = {
  ...
  'Andhra Pradesh': {
    districts: [
      ...
      'YSR Kadapa', 'Annamayya', 'Alluri Sitharama Raju', 'Bapatla', 'Eluru', 'Kakinada', 
      'Konaseema', 'Nandyal', 'Palnadu', 'Parvathipuram Manyam', 'Sri Sathya Sai', 'Tirupati'
    ],
    type: 'State',
    active: false
  },
  ...
  'Nagaland': {
    districts: [
      ...
      'Niuland', 'Noklak', 'Peren', 'Phek', 'Shamator', 'Tuensang', 'Wokha', 'Zünheboto'
    ],
    type: 'State',
    active: false
  },
  ...
  'Punjab': {
    districts: [
      ...
      'Rupnagar', 'Sangrur', 'Shaheed Bhagat Singh Nagar', 'Sri Muktsar Sahib', 'Tarn Taran'
    ],
    type: 'State',
    active: false
  },
  ...
  'Tamil Nadu': {
    districts: [
      ...
      'Tirupathur', 'Tiruppur', 'Tiruvallur', 'Tiruvannamalai', 'Vellore', 'Viluppuram', 
      'Virudhunagar'
    ],
    type: 'State',
    active: true
...
// Helper function to get all states and UTs
export const getAllStatesAndUTs = () => {
  return Object.keys(indianStatesAndDistricts);
};

// Helper function to get districts for a state/UT
export const getDistrictsForState = (stateName) => {
  return indianStatesAndDistricts[stateName]?.districts || [];
};

// Helper function to get state/UT info
export const getStateInfo = (stateName) => {
  return indianStatesAndDistricts[stateName] || null;
};

// Get all states (excluding UTs)
export const getAllStates = () => {
  return Object.entries(indianStatesAndDistricts)
    .filter(([_, info]) => info.type === 'State')
    .map(([name, _]) => name);
};
...
export const getAllUnionTerritories = () => {
  return Object.entries(indianStatesAndDistricts)
    .filter(([_, info]) => info.type === 'Union Territory')
    .map(([name, _]) => name);
};
