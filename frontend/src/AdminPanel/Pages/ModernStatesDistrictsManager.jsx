...
const ModernStatesDistrictsManager = () => {
  ...
  // Form states - simplified to only name, type, and districts
  ...
  const handleUpdateDistricts = async (stateName, districts) => {
    try {
      setActionLoading(stateName);
      const response = await axios.put(
        API_ENDPOINTS.UPDATE_DISTRICTS(stateName),
        { districts }
      );
      if (response.data.success) {
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">Add and manage Indian states, union territories, and their districts</p>
          </div>
          <motion.button
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-gray-600 mt-4">
                        ...
                        <span className="text-sm">{state.districtCount || state.districts?.length || 0} Districts</span>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      {formData.districts.length === 0 && (
                        <p className="text-gray-500 text-sm">No districts added yet. Click + to add districts.</p>
                      )}
                    </div>
                  </div>
                </div>
